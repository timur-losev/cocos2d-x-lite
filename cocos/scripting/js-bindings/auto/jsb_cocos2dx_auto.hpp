...
SE_DECLARE_FUNC(js_cocos2dx_Node_getonEnterTransitionDidFinishCallback);
...
SE_DECLARE_FUNC(js_cocos2dx_Node_getOnEnterCallback);
...
SE_DECLARE_FUNC(js_cocos2dx_Node_addOnExitCallback);
...
SE_DECLARE_FUNC(js_cocos2dx_Node_addOnEnterCallback);
...
SE_DECLARE_FUNC(js_cocos2dx_Node_getOnExitCallback);
...
SE_DECLARE_FUNC(js_cocos2dx_Node_getonExitTransitionDidStartCallback);
...
SE_DECLARE_FUNC(js_cocos2dx_Image_initWithImageData);
...
SE_DECLARE_FUNC(js_cocos2dx_Device_getIdentifier);
SE_DECLARE_FUNC(js_cocos2dx_Device_getOSVersion);
...
SE_DECLARE_FUNC(js_cocos2dx_Application_getPackageIdentifier);
